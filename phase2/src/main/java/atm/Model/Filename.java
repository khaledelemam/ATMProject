...
public class Filename implements Serializable {
    ...
    public String getCashFile() { return "phase2/src/main/java/atm/Model/textFiles/cash.txt"; }

    public String getAlertFile() {
        return "phase2/src/main/java/atm/Model/textFiles/alerts.txt";
    }


    /** File path for outgoing file used in PayBills */
    public String getOutgoingFile() { return "phase2/src/main/java/atm/Model/textFiles/outgoing.txt";}
