...
public class InterfaceUser {
    ...
    public ComboBox<Account> accountsDeposit;
    public ComboBox<Account> accountsWithdraw;
    // end
    ...
    public void setUpUser(String username) throws IOException {
        ...
        accountsWithdraw.setItems(atm2.getAccounts());
        accountsDeposit.setItems(atm2.getAccounts());
    ...
    public void deposit(ActionEvent actionEvent) {
        if (checkInput(depositAmountField.getText())){
            ...
            Account account = accountsDeposit.getSelectionModel().getSelectedItem();
            double amount = Double.parseDouble(depositAmountField.getText());
            depositMessage.setText(atm2.deposit(amount, account));
        }
        else{
    ...
    public void withdraw(ActionEvent actionEvent) {
        Account account = accountsWithdraw.getSelectionModel().getSelectedItem();
        withdrawMessage.setText(atm2.withdraw(Double.valueOf((withdraw_cbox.getSelectionModel().getSelectedItem())), account));
    }
